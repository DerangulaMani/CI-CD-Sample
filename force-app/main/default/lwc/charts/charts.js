...
export default class Charts extends LightningElement {
    ...
    renderedCallback(){
        ...
        loadScript(this, chartJs+'/chartJs/Chart.js').then(()=>{
            ...
            this.chartData = [0, 0, 2140];
            this.chartLabels = ['positive', 'deaths', 'total'];
            this.chartHeading = 'CovidApp'
            this.loadCharts()
        }).catch(error=>{
            console.error(error)
        })
    ...
    loadCharts(){
        console.log(' Hii I AM Present Inside loadCharts() ');
    ...
    @api deleteDom(array)
    {
        console.log('Hii I am Present Inside deleteDom() Method ')
        ...
        console.log(array);
        this.chartData = [...Object.values(array)];
        this.chartLabels =[...Object.keys(array)];
        this.loadCharts();
    }
    config(){
        return {
